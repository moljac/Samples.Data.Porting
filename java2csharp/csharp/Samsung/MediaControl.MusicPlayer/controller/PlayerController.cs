...
namespace com.samsung.android.sdk.sample.musicplayer.controller
{
	...
	public class PlayerController
	{
		...
		public interface PlayerControllerEvents
		{
			...
			/// <param name="position"> current media mPosition. </param>
		...
		private readonly PlayerControllerEvents mEventListener;
		...
		public PlayerController(Context context, PlayerControllerEvents listener, Uri contentUri, string mimetype, PlayerState playerState)
		{
			mContext = context;
		...
		/// Calls <seealso cref="PlayerControllerEvents#onStateChanged(PlayerState)"/> if
