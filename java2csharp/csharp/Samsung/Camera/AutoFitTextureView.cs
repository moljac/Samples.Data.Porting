...
namespace com.samsung.android.sdk.camera.sample.cases.util
{
	...
	/// <summary>
	/// A <seealso cref="TextureView"/> that can be adjusted to a specified aspect ratio.
	/// </summary>
	public class AutoFitTextureView : TextureView
	{
		...
		public AutoFitTextureView(Context context, AttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
		{
		}
