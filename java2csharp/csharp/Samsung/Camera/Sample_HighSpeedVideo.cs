...
namespace com.samsung.android.sdk.camera.sample.cases
{
	...
	/// </summary>
	public class Sample_HighSpeedVideo : Activity, AdapterView.OnItemSelectedListener
	{
		/// <summary>
		/// Tag for the <seealso cref="Log"/>.
		/// </summary>
		private const string TAG = "Sample_HighSpeedVideo";
		...
		private IList<SCaptureRequest> mRepeatingList;
...
//ORIGINAL LINE: @SuppressWarnings("deprecation") private boolean checkRequiredFeatures()
		...
		{
			private readonly Sample_HighSpeedVideo outerInstance;

			public OnClickListenerAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance)
			{
		...
		private class SurfaceTextureListenerAnonymousInnerClassHelper : TextureView.SurfaceTextureListener
		{
			...
			public SurfaceTextureListenerAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance)
			{
				this.outerInstance = outerInstance;
			}
		...
		private class StateCallbackAnonymousInnerClassHelper : SCameraDevice.StateCallback
		{
			...
			public StateCallbackAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance)
			{
				this.outerInstance = outerInstance;
			}
...
//ORIGINAL LINE: final java.io.File file = new java.io.File(dir, createFileName() + "_hsv.mp4");
				...
				MediaScannerConnection.scanFile(Sample_HighSpeedVideo.this, new string[]{file.AbsolutePath}, null, new OnScanCompletedListenerAnonymousInnerClassHelper(this));
		...
		private class OnScanCompletedListenerAnonymousInnerClassHelper : MediaScannerConnection.OnScanCompletedListener
		{
			...
			public OnScanCompletedListenerAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance)
			{
				this.outerInstance = outerInstance;
			}
		...
		private class OrientationEventListenerAnonymousInnerClassHelper : OrientationEventListener
		{
			...
			public OrientationEventListenerAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance) : base(outerInstance)
			{
				this.outerInstance = outerInstance;
			}
...
//ORIGINAL LINE: final android.app.AlertDialog.Builder dialog = new android.app.AlertDialog.Builder(this);
		...
		private class OnClickListenerAnonymousInnerClassHelper : DialogInterface.OnClickListener
		{
			...
			public OnClickListenerAnonymousInnerClassHelper(Sample_HighSpeedVideo outerInstance, bool finishActivity, AlertDialog.Builder dialog)
			{
				this.outerInstance = outerInstance;
