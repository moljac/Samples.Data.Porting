...
namespace com.samsung.android.example.slookdemos
{
	...
	public class AirButtonManualActivity : Activity
	{
		...
		protected internal override void onCreate(Bundle savedInstanceState)
		{
			...
			mAirButton.AutoControlEnabled = false;
		...
		{
			private readonly AirButtonManualActivity outerInstance;

			public RendererAnonymousInnerClassHelper(AirButtonManualActivity outerInstance)
			{
		...
		private class OnHoverListenerAnonymousInnerClassHelper : View.OnHoverListener
		{
			...
			public OnHoverListenerAnonymousInnerClassHelper(AirButtonManualActivity outerInstance)
			{
				this.outerInstance = outerInstance;
			}
