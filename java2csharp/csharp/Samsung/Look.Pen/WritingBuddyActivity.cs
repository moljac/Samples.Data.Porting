...
namespace com.samsung.android.example.slookdemos
{
	...
	public class WritingBuddyActivity : ListActivity
	{
		...
		private IList<IDictionary<string, object>> Data
		{
			get
			{
				...
				addItem(myData, "1. EditText", activityIntent("com.samsung.android.example.slookdemos.WritingBuddyEditTextActivity"));
				addItem(myData, "2. ViewGroup", activityIntent("com.samsung.android.example.slookdemos.WritingBuddyViewGroupActivity"));
				return myData;
			}
		}
