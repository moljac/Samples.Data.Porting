...
namespace com.microsoft.azure.engagement.activity
{
	...
	using ActivityGroup = android.app.ActivityGroup;
...
//ORIGINAL LINE: @SuppressWarnings("deprecation") public abstract class EngagementActivityGroup extends android.app.ActivityGroup
	public abstract class EngagementActivityGroup : ActivityGroup
	{
