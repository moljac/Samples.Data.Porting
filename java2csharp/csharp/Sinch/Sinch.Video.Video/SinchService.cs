namespace com.sinch.android.rtc.sample.video
{
	...
	public class SinchService : Service
	{
		...
		public class SinchServiceInterface : Binder
		{
			...
			public virtual Call callUserVideo(string userId)
			{
				return outerInstance.mSinchClient.CallClient.callUserVideo(userId);
			}
			...
			public virtual VideoController VideoController
			{
				get
				{
					...
					return outerInstance.mSinchClient.VideoController;
				}
			}

			public virtual AudioController AudioController
			{
				get
				{
					if (!Started)
					...
					return outerInstance.mSinchClient.AudioController;
				}
			}
		}
