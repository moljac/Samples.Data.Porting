...
namespace com.opentok.android.demo.opentoksamples
{
	...
	public class DefaultCameraCapturerActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{
		...
		public override void onPause()
		{
			...
			Intent notificationIntent = new Intent(this, typeof(DefaultCameraCapturerActivity));
			...
			if (!mIsBound)
			{
				bindService(new Intent(DefaultCameraCapturerActivity.this, typeof(ClearNotificationService)), mConnection, Context.BIND_AUTO_CREATE);
				mIsBound = true;
		...
		{
			private readonly DefaultCameraCapturerActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(DefaultCameraCapturerActivity outerInstance)
			{
		...
		private void sessionConnect()
		{
			if (mSession == null)
			{
				mSession = new Session(DefaultCameraCapturerActivity.this, OpenTokConfig.API_KEY, OpenTokConfig.SESSION_ID);
