...
namespace com.opentok.android.demo.opentoksamples
{
	...
	using CustomVideoRenderer = com.opentok.android.demo.video.CustomVideoRenderer;

	public class VideoRendererActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{

		private const string LOGTAG = "demo-customer-video-capturer";
		...
		public override void onPause()
		{
			...
			Intent notificationIntent = new Intent(this, typeof(VideoRendererActivity));
			...
			if (!mIsBound)
			{
				bindService(new Intent(VideoRendererActivity.this, typeof(ClearNotificationService)), mConnection, Context.BIND_AUTO_CREATE);
				mIsBound = true;
		...
		{
			private readonly VideoRendererActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(VideoRendererActivity outerInstance)
			{
		...
		private void subscribeToStream(Stream stream)
		{
			...
			mSubscriber.Renderer = new CustomVideoRenderer(this);
		...
		public override void onConnected(Session session)
		{
			...
			if (mPublisher == null)
			{
				...
				mPublisher.Renderer = new CustomVideoRenderer(this);
