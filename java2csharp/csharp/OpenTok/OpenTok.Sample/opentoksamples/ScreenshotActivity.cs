...
namespace com.opentok.android.demo.opentoksamples
{
	...
	using BasicCustomVideoRenderer = com.opentok.android.demo.video.BasicCustomVideoRenderer;

	public class ScreenshotActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{
		...
		protected internal override void onCreate(Bundle savedInstanceState)
		{
			...
			ContentView = R.layout.screenshot_layout;
		...
		public override void onPause()
		{
			...
			Intent notificationIntent = new Intent(this, typeof(ScreenshotActivity));
			...
			if (!mIsBound)
			{
				bindService(new Intent(ScreenshotActivity.this, typeof(ClearNotificationService)), mConnection, Context.BIND_AUTO_CREATE);
				mIsBound = true;
		...
		{
			private readonly ScreenshotActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(ScreenshotActivity outerInstance)
			{
		...
		public virtual void onSaveScreenshot(View view)
		{
			if (mSubscriber != null)
			{
				((BasicCustomVideoRenderer) mSubscriber.Renderer).saveScreenshot(true);
			}
		}
		...
		private void sessionConnect()
		{
			if (mSession == null)
			{
				mSession = new Session(ScreenshotActivity.this, OpenTokConfig.API_KEY, OpenTokConfig.SESSION_ID);
		...
		public override void onConnected(Session session)
		{
			...
			if (mPublisher == null)
			{
				...
				mPublisher.Renderer = new BasicCustomVideoRenderer(this);
		...
		private void subscribeToStream(Stream stream)
		{
			...
			mSubscriber.Renderer = new BasicCustomVideoRenderer(this);
		...
		private void attachSubscriberView(Subscriber subscriber)
		{
			...
			screenshotWidget.Visibility = View.VISIBLE;
		}
