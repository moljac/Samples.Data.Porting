...
namespace com.opentok.android.demo.opentoksamples
{
	...
	/// samples directory.
	/// </summary>
	public class HelloWorldActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{
		...
		{
			private readonly HelloWorldActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(HelloWorldActivity outerInstance)
			{
