...
namespace com.opentok.android.demo.opentoksamples
{
	...
	using CustomVideoCapturer = com.opentok.android.demo.video.CustomVideoCapturer;

	public class VideoCapturerActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{
		...
		public override void onPause()
		{
			...
			Intent notificationIntent = new Intent(this, typeof(VideoCapturerActivity));
			...
			if (!mIsBound)
			{
				bindService(new Intent(VideoCapturerActivity.this, typeof(ClearNotificationService)), mConnection, Context.BIND_AUTO_CREATE);
				mIsBound = true;
		...
		{
			private readonly VideoCapturerActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(VideoCapturerActivity outerInstance)
			{
		...
		public override void onConnected(Session session)
		{
			...
			if (mPublisher == null)
			{
				...
				mPublisher.Capturer = new CustomVideoCapturer(VideoCapturerActivity.this);
