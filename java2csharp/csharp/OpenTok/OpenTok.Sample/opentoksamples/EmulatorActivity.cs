...
namespace com.opentok.android.demo.opentoksamples
{
	...
	using CustomEmulatorVideoCapturer = com.opentok.android.demo.video.CustomEmulatorVideoCapturer;

	public class EmulatorActivity : Activity, Session.SessionListener, Publisher.PublisherListener, Subscriber.VideoListener
	{
		...
		public override void onPause()
		{
			...
			Intent notificationIntent = new Intent(this, typeof(EmulatorActivity));
			...
			if (!mIsBound)
			{
				bindService(new Intent(EmulatorActivity.this, typeof(ClearNotificationService)), mConnection, Context.BIND_AUTO_CREATE);
				mIsBound = true;
		...
		{
			private readonly EmulatorActivity outerInstance;

			public ServiceConnectionAnonymousInnerClassHelper(EmulatorActivity outerInstance)
			{
		...
		private void sessionConnect()
		{
			if (mSession == null)
			{
				mSession = new Session(EmulatorActivity.this, OpenTokConfig.API_KEY, OpenTokConfig.SESSION_ID);
		...
		public override void onConnected(Session session)
		{
			...
			if (mPublisher == null)
			{
				...
				mPublisher.Capturer = new CustomEmulatorVideoCapturer(EmulatorActivity.this);
