LOG_TAG := audiosuite:sapainstrumentsample:n
...
MY_PACKAGE_NAME := com.samsung.audiosuite.sapainstrumentsample

LOCAL_CPP_EXTENSION := .cpp
LOCAL_MULTILIB := 32
LOCAL_MODULE    := wave
LOCAL_SRC_FILES := \
	InstrumentSampleAPAClient.cpp \
	InstrumentSampleJackClient.cpp \
	StereoPort.cpp
