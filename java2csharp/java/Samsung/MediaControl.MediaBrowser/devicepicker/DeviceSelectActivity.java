...
public class DeviceSelectActivity extends ListActivity implements OnClickListener, SmcDeviceFinder.StatusListener, SmcDeviceFinder.DeviceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mType = getIntent().getIntExtra("deviceType", SmcDevice.TYPE_IMAGEVIEWER);
    ...
    private class DevicesAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            SmcDevice device = mDevices.get(position);
            if(device instanceof SmcImageViewer){
                label.setText("[ImageViewer] "+device.getName());
            }else if(device instanceof SmcAvPlayer){
                label.setText("[AVPlayer] "+device.getName());
            }else if(device instanceof SmcProvider){
                label.setText("[Provider] "+device.getName());
            }else
