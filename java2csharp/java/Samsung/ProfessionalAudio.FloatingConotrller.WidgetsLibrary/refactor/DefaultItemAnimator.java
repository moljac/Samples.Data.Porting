...
class DefaultItemAnimator extends RecyclerView.ItemAnimator {
    ...
    protected ArrayList<ViewHolder> mPendingRemovals = new ArrayList<ViewHolder>();
    protected ArrayList<ViewHolder> mPendingAdditions = new ArrayList<ViewHolder>();
    protected ArrayList<MoveInfo> mPendingMoves = new ArrayList<MoveInfo>();
    protected ArrayList<ChangeInfo> mPendingChanges = new ArrayList<ChangeInfo>();
...
//                    ", newHolder=" + newHolder +
        ...
        public boolean hasNoTranslation() {
    ...
    protected void endChangeAnimation(List<ChangeInfo> infoList, ViewHolder item) {
    ...
    protected void onPreEndAnimation(ViewHolder item) {
        // NOOP
    }
